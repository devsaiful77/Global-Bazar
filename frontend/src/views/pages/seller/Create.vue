            ...
            <section class="inner-section shop-part">
                <div class="container">
                            ...
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-label">
                                        <label class="label-text sale">new</label><label
                                            class="view-label off">-5%</label>
                                    </div>
                                    <div>
                  ...
                  ><a href="product-video.html">(3)</a>
                                    ...
                                    <h6 class="product-name">
                                        <a href="/product/core-i3-12100-12th-gen-pc" class="">Core i3 12100 12th Gen
                                            PC</a>
                                    </h6>
                                    <div>
                                        <!-- //jodi modal ba single product page theke data ase.. tahole h3 design  -->
                  ...
                  ><a href="product-video.html">(3)</a>
                                    ...
                                    <h6 class="product-name">
                                        <a href="/product/canon-eos-250d-241mp-full-hd-dslr-camera" class="">CANON EOS
                                            250D 24.1MP Full HD DSLR Camera</a>
                                    </h6>
                                    <div>
                                        <!-- //jodi modal ba single product page theke data ase.. tahole h3 design  -->
                                        <h6 class="product-price">
                  ...
                  ><a href="product-video.html">(3)</a>
                                    ...
                                    <h6 class="product-name">
                                        <a href="/product/canon-eos-200d-dsl-camera" class="">Canon Eos 200D Dsl
                                            Camera</a>
                                    </h6>
                                    <div>
                                        <!-- //jodi modal ba single product page theke data ase.. tahole h3 design  -->
