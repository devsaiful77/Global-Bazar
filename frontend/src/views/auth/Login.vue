                            ...
                            <div class="user-form-group" id="axiosForm">
                                <form class="user-form" @submit.prevent="login">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" v-model="form.phone" placeholder="phone no" />
                                        <!--v-if-->
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" v-model="form.password" placeholder="password" /><span
                                            class="view-password"><i class="fas text-success fa-eye"></i></span>
                                        <!--v-if-->
                                    </div>
